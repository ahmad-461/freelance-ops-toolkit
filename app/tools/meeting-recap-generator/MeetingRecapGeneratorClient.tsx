...
- Next sync call scheduled for Wednesday 2 PM.`}
        ...
        <ToolSeoContent
          h2Title="Maintain Alignment with an Automated Meeting Recap Email Generator"
          intro="Following client meetings with a written recap is critical for maintaining project alignment and preventing scope creep. However, writing these emails manually can consume valuable billable hours. Our free meeting recap email generator leverages context-driven AI to instantly convert raw meeting notes or messy scribbles into beautifully structured summaries complete with action items."
          sections={[
            {
              title: "How to Write a Meeting Summary Email That Prevents Scope Creep",
              prose: "To write an effective summary, organize your notes into three distinct parts: a high-level summary of discussed points, a list of finalized decisions (e.g. approved wireframe color schemes), and a clear 'Action Items' section that assigns tasks and deadlines explicitly. This structure establishes an indisputable record, protecting your timeline from misunderstandings."
            },
            {
            ...
            },
            {
              ...
              prose: "Always send your recap summary email within 24 hours of the meeting while the details are fresh. Standardizing this boundary not only reinforces your operational professionalism but also prompts the client to flag any misinterpretations immediately before you spend time executing tasks."
            }
          ]}
          internalLinks={[
