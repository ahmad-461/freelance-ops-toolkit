  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen pb-16 transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ToolSeoContent
          h2Title="Streamline Onboarding with a Client Intake Form Template"
          intro="Onboarding a new client successfully depends on gathering precise, structured parameters about their business, budget, and project expectations early. Our client intake form template builder provides a complete system to draft onboarding questionnaires custom-tailored to your workflow. Output clean plain text or export premium, print-ready PDF questionnaires for your clients to complete."
          sections={[
            {
              title: "Why Every Freelancer Needs a New Client Onboarding Form",
              prose: "Gathering project details through disorganized email threads or casual syncs increases the risk of misalignment and project scope creep. A standardized onboarding questionnaire ensures you collect key project assumptions—such as target deadlines, precise budget parameters, technical specifications, and brand assets—before drafting formal agreements or pricing structures."
            },
            {
              title: "Crafting the Perfect Freelance Client Questionnaire",
              prose: "The perfect onboarding form should cover multiple distinct aspects of the client's business. Include categories targeting project goals (what success looks like), financial frameworks (available budget and flexibility), timelines (launch targets), brand context (existing guidelines), and technical requirements (API integrations, platforms)."
            },
            {
              title: "Avoiding Onboarding Bottlenecks with Automation",
              prose: "Making client onboarding frictionless speeds up project kick-off. Once your onboarding template is built, copy the plain text version directly into your preferred email template, or send the clean PDF. Establishing this boundary signals professionalism and saves you hours of back-and-forth discovery meetings."
            }
          ]}
          internalLinks={[
